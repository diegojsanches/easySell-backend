...
var CreateProductService = /** @class */ (function () {
    ...
    CreateProductService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var findProductWhitSameCode, product;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.productsRepository.findByCode(code)];
                    case 1:
                        findProductWhitSameCode = _b.sent();
                        if (findProductWhitSameCode) {
                            throw new AppError_1.default('This product is already added.');
                        }
