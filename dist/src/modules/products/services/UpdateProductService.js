...
var UpdateProductService = /** @class */ (function () {
    ...
    UpdateProductService.prototype.execute = function (_a) {
        var product_id = _a.product_id, code = _a.code, description = _a.description, stock = _a.stock, price = _a.price, cost = _a.cost;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        product = _b.sent();
                        if (!product) {
                            throw new AppError_1.default('Product dont exist', 401);
                        }
                        product.code = code;
