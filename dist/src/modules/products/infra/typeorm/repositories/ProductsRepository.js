...
var ProductsRepository = /** @class */ (function () {
    ...
    ProductsRepository.prototype.findByCode = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            var findProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductsRepository.prototype.filterByQuery = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            var filterProducts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.find({
                            where: [{ code: q }, { description: typeorm_1.Like(q + "%") }],
                        })];
                    case 1:
                        filterProducts = _a.sent();
                        return [2 /*return*/, filterProducts];
                }
            });
        });
    };
