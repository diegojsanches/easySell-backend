...
describe('CreateProduct', function () {
    ...
    it('should be able to create a new product', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createProduct.execute({
                        code: '1234',
    ...
    it('should not be able to create two product at the same code', function () { return __awaiter(void 0, void 0, void 0, function () {
        var productDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    productDate = date_fns_1.addDays(date_fns_1.setHours(Date.now(), 10), 6);
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createProduct.execute({
                            code: '1234',
                            description: 'Produto1',
                            stock: 3,
                            price: 50,
