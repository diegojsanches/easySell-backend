...
var SaleItem_1 = __importDefault(require("./SaleItem"));
var Sale = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return SaleItem_1.default; }, function (item) { return item.sale; }, { cascade: true }),
