...
var UpdateProficeService_1 = __importDefault(require("@modules/users/services/UpdateProficeService"));
...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, _a, name, email, password, old_password, updateProfile, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user_id = req.user.id;
                        _a = req.body, name = _a.name, email = _a.email, password = _a.password, old_password = _a.old_password;
                        updateProfile = tsyringe_1.container.resolve(UpdateProficeService_1.default);
