            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Only authenticated users can alter profile', 401);
                        }
                    ...
                    case 2:
                        ...
                        if (!old_password) {
                            throw new AppError_1.default('You need to informe old password to set new password');
                        }
                        return [4 /*yield*/, this.hashProvider.compareHash(old_password, user.password)];
                    case 3:
                        checkOldPassword = _c.sent();
                        if (!checkOldPassword) {
                            throw new AppError_1.default('Old password this not match.');
                        }
                        _b = user;
